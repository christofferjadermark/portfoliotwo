    ...
    <Layout>
      <div className="isolate bg- px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-primaryFont text-3xl tracking-tight text-white sm:text-4xl">
            Contact me
          </h2>
        </div>
        <form
        ...
        >
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
              <label
                htmlFor="first-name"
                required
                className="block text-sm font-primaryFont leading-6 text-white"
              >
                First name
              </label>
          ...
          <div className="mt-10">
            <button
              type="submit"
              className="block w-full rounded-md bg-textSecondary px-3.5 py-2.5 text-center text-sm font-semibold font-primaryFont text-bgColor shadow-sm"
            >
              Let's talk
            </button>
          </div>
